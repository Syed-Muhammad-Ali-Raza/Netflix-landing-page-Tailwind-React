...
const Faq = () => {
    ...
    return (
        <div className='container px-20 h-[100vh]'>
            <h2 className='text-5xl font-bold text-center py-12'>Frequently Asked Questions</h2>

            <div
                className={`question1   bg-slate-600  mx-32 flex justify-between px-12 py-3 my-2 hover:bg-slate-400 ${
                    openQuestion === 1 ? 'open' : ''
                }`}
            ...
            <div
                className={`question2 bg-slate-600  mx-32 flex justify-between px-12 py-3 my-2 hover:bg-slate-400  ${
                    openQuestion === 2 ? 'open' : ''
                }`}
            ...
            <div
                className={`question3  my-2  mx-32 bg-slate-600  flex justify-between px-12 py-3 hover:bg-slate-400 ${
                    openQuestion === 3 ? 'open' : ''
                }`}
...
<div
                className={`question4  my-2  mx-32 bg-slate-600  flex justify-between px-12 py-3 hover:bg-slate-400 ${
                    openQuestion === 4 ? 'open' : ''
                }`}
                onClick={() => handleQuestionClick(3)}
            >
...
<div
                className={`question5  my-2  mx-32 bg-slate-600  flex justify-between px-12 py-3 hover:bg-slate-400 ${
                    openQuestion === 5 ? 'open' : ''
                }`}
...
<div
                className={`question6  my-2  mx-32 bg-slate-600  flex justify-between px-12 py-3 hover:bg-slate-400 ${
                    openQuestion === 6 ? 'open' : ''
                }`}
...
<div
                className={`question7  my-2  mx-32 bg-slate-600  flex justify-between px-12 py-3 hover:bg-slate-400 ${
                    openQuestion === 7 ? 'open' : ''
                }`}
